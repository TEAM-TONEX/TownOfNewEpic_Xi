...
public class Main : BasePlugin
{
    ...
    public const string PluginVersion = "1.2.38";
    public const string PluginShowVersionPrefix = "1.3_20240705";
    public const string PluginShowVersionPostfix = "_Debug_28";
